...
def get_int(mensaje: str, minimo: int, maximo: int) -> int|None:
    ...
    validacion = validate_int_number("ERROR. Ingrese nuevamente su numero: ", minimo, maximo, 3, numero)

    return validacion

clave_bancaria = get_int("Ingrese su numero: ", 500, 1000)
...
def get_string(mensaje: str, minimo: int, maximo: int) -> str|None:
    ...
    validate = validate_length("ERROR. Ingrese nuevamente la contraseña: ", minimo, maximo, 3, longitud)

    return texto

texto = get_string("Ingrese la contraseña: ", 8, 8)
