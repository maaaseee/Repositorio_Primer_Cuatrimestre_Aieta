...
class Video:
    ...
    def dividir_titulo(self):
        ...
        return self.colaborador, self.sesion
    ...
    def calcular_maximo_reproducciones(lista_videos: list):
        ...
        for i in range(len(lista_videos)):
            if bandera == True or maximo_reproducciones < lista_videos.vistas:
                maximo_reproducciones = lista_videos[i].vistas

        return maximo_reproducciones
    
    def buscar_codigo_url(lista_videos: list):
        subcadena = "nick"
        for i in range(len(lista_videos)):
    ...
    def buscar_por_mes(lista_videos: list):
        pass